...
import { idlFactory } from './proyectomotoko1_backend.did.js';
export { idlFactory } from './proyectomotoko1_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PROYECTOMOTOKO1_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./proyectomotoko1_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the proyectomotoko1_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./proyectomotoko1_backend.did.js")._SERVICE>}
 */
export const proyectomotoko1_backend = createActor(canisterId);
